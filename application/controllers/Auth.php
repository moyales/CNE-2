...
class Auth extends CI_Controller {
	...
	public function view($page = 'login_body')
	{
			...
			switch ($page)
			{
				case "login_error": $data['title'] = "Login"; $this->load->view('templates/login_header', $data); $this->load->view('pages/login_error', $data); $this->load->view('pages/login', $data); break;
