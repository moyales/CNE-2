    ...
    <div class="table-responsive">
        ...
        <?php
            ...
            $template = array(
                ...
                'row_start'             => '<tr class="table-tr">',
                'row_end'               => '</tr>',
                'cell_start'            => '<td>',
                'cell_end'              => '</td>',

                'row_alt_start'         => '<tr class="table-tr-alt">',
                'row_alt_end'           => '</tr>',
                'cell_alt_start'        => '<td>',
                'cell_alt_end'          => '</td>',
...
<div class="report-container">
    ...
    <h3 class="report-title">Income History</h3>
    ...
    <div class="table-responsive">
        ...
        <?php
            ...
            $this->table->set_heading('Income Type', 'Income Source', 'Frequency', 'Date', 'Amount ($)');

            
            foreach ($INCOME as $i):
                $this->table->add_row($i->incomeType, $i->incomeSource, $i->incomeFrequency, $i->incomeStartingDate, $i->incomeAmount);
            endforeach;
