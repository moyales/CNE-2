...
class Main_model extends CI_Model {
    ...
    */
    ...
    function getIncomeHistoryData () 
    {
        $sql = "SELECT `username`, `incomeType`, `incomeSource`, `incomeFrequency`, `incomeStartingDate`, `incomeAmount` FROM `main_income`" . " WHERE username = '" . $_SESSION['username'] . "'";
